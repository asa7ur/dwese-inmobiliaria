...
INSERT IGNORE INTO properties (description, location, price, type, floors, bedrooms, bathrooms, status, image) VALUES
    ...
    ('Small cabin within the walls, minimal light.', 'Shiganshina District', 150000.00, 'CABIN', 1, 2, 1, 'RESERVED', 'prop_4.jpg'),
    ...
    ('Trendy loft in the heart of Los Angeles.', 'Hollywood, CA', 1500000.00, 'FLAT', 2, 3, 2, 'RESERVED', 'prop_12.jpg'),
...
INSERT IGNORE INTO property_agent (property_id, agent_id) VALUES
    (1, 1), -- Rick and Walter for prop 1
    (1, 3),
    (2, 2),
    (2, 4), -- Snape and Eren for prop 2
    (3, 3), -- Rick for prop 3
    (4, 4), -- Eren for prop 4
    ...
    (25, 2),
    (25, 6); -- Snape and Elliot for prop 25
...
INSERT IGNORE INTO transactions (transaction_timestamp, status, price, property_id, client_id, agent_id) VALUES
    ...
    (1727000000, 'CANCELLED', 4500000.00, 6, 6, 6), -- Darlene is buying Prop 6
